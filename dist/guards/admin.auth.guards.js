...
let AdminAuthGuards = class AdminAuthGuards {
    ...
    async canActivate(context) {
        ...
        try {
            ...
            if (!(user.role === "admin")) {
                throw new common_1.UnauthorizedException("User does't have permission");
            }
            request.user = user;
        }
        catch (e) {
...
exports.AdminAuthGuards = AdminAuthGuards;
exports.AdminAuthGuards = AdminAuthGuards = __decorate([
